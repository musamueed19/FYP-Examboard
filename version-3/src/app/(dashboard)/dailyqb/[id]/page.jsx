...
import ViewDailyQBTable from "@/components/Tables/viewDailyqbTable";
...
export default function DailyQBStatusPage() {
  ...
  return (
    <div className="container">
      <h1 className="titleHeader">View Question Wise Daily Status</h1>
      ...
      <ViewDailyQBTable records={records} setModal={setModal} setType={setType} setId={setQbId}/>
